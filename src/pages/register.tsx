...
import { primaryColor, primaryFontSize, fetchData, requestURL, disabledTextColor } from "../utils";
interface Props {
	screenProps: any;
	navigation: any;
}
	...
	async getCode() {
		...
		if (phone != "") {
			...
			try {
				...
				console.log(result);
				Alert.alert("提示", "" + result.data.msg);
				this.setState({
					codeCold: true
				}, () => {
				...
				<View>
					...
					<View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
						...
						<TouchableOpacity
							...
							{
								this.state.codeCold ? <Text style={{ color: disabledTextColor, fontSize: primaryFontSize }}>{this.state.codeColdTime + "秒后重试"}</Text> : <Text style={{ color: primaryColor, fontSize: primaryFontSize }}>获取验证码</Text>
							}
						</TouchableOpacity>
					</View>
				</View>
